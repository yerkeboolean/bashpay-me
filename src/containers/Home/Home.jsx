...
class Home extends Component {
  ...
  render() {
    ...
    return (
      <div className={clsx(classes.home, { [classes.home_active]: show })}>
        {show ? (
          <Fragment>
            ...
            <div className={classes.home_player_close} onClick={this.close} />
            <div className={classes.home_video_description}>
              <div className={classes.home_video_description_name}>
                {listOfProjects[current].title}
              </div>
              <div className={classes.home_video_description_type}>
                {listOfProjects[current].type}
              </div>
              <div className={classes.home_video_description_text}>
          ...
          <Fragment>
            <div
              className={classes.home_img_wrapper}
              style={{ backgroundImage: `url(${listOfProjects[current].img})` }}
            ></div>
            <div className={classes.home__project_name}>
              {listOfProjects[current].title}
            </div>
            <div className={classes.home__play_button} onClick={this.play} />
            <div className={classes.home__project_type}>
              {listOfProjects[current].type}
            </div>
            <div className={classes.home__project_arrows}>
              <div
                className={classes.home__arrow_left}
                onClick={this.previous}
              />
              <div className={classes.home__arrow_right} onClick={this.next} />
            </div>
          </Fragment>
        )}
      </div>
